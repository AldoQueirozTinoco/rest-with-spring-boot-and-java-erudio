...
public class User implements UserDetails, Serializable{
	...
	@Column(name = "user_name", unique = true) // Unique = só pode ter 1, o hibernate não aceitará nomes repetidos
	...
	public List<String> getRoles() {
		...
		for(Permission permission: permissions) { // Quebra de convenção nessesária tendo em vista a implementação de UserDetails
